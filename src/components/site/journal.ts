...
const ENTRIES: JournalEntry[] = [
  ...
  {
    id: 8,
    kicker: "The Bus Factor Risk",
    title: "“ဒီ System ကို သူတစ်ယောက်ပဲသိတယ်” ဆိုတာ ဘယ်လောက်အန္တရာယ်ရှိလဲ?",
    category: "Engineering",
    date: "2026-09-17",
    excerpt:
      "“ဒီ Module ကို ဘယ်သူသိလဲ?” “Dev A သိတယ်။” “သူမရှိရင်?” — အဖြေမရှိတော့ရင် အဲ့ဒီ Project မှာ Bus Factor Risk ရှိနေပြီ။ Knowledge ကို လူတစ်ယောက်တည်းပေါ် မှီခိုထားခြင်းက ဘယ်လောက်အန္တရာယ်ရှိပြီး ဘယ်လိုလျှော့ချမလဲဆိုတာ ဆန်းစစ်ကြည့်ထားတယ်။",
    body: [
      {
        type: "p",
        text: "“ဒီ Module ကို ဘယ်သူသိလဲ?” “Dev A သိတယ်။” “သူမရှိရင်?” “……….”",
      },
      {
        type: "p",
        text: "Software Team တွေမှာ ဒီလိုအခြေအနေမျိုး တော်တော်တွေ့ရတယ်။ Git ရှိတယ်။ Documentation ရှိတယ်။ Code Review လုပ်တယ်။ Test တွေလည်း ရှိတယ်။ ဒါပေမယ့် Production မှာ ပြဿနာတစ်ခုတက်လာရင်— “Dev A ပြန်လာမှ ကြည့်လို့ရမယ်” ဆိုရင် အဲ့ဒီ Project မှာ Bus Factor Risk ရှိနေပြီ။",
      },
      { type: "h", text: "Bus Factor ဆိုတဲ့နာမည်က ဘယ်ကလာတာလဲ?" },
      {
        type: "p",
        text: "နာမည်က နည်းနည်းကြမ်းတယ်။ “Team ထဲက အရေးကြီးတဲ့ Developer တွေထဲက ဘယ်နှယောက် Bus တိုက်ခံရပြီး ရုတ်တရက်မရှိတော့ရင် Project က ဆက်သွားလို့မရတော့ဘူးလဲ?” ဆိုတဲ့ မေးခွန်းကနေ ဒီနာမည်ဖြစ်လာတာ။ တကယ်တော့ Bus တိုက်ခံရမယ်ဆိုတာကို ပြောတာမဟုတ်ဘူး။ လူတစ်ယောက်က ရုတ်တရက် မရှိတော့တာကို ဥပမာပေးထားတာ။ Leave ယူတာဖြစ်နိုင်တယ်။ Company ကထွက်သွားတာဖြစ်နိုင်တယ်။ အခြား Project ကိုပြောင်းသွားတာဖြစ်နိုင်တယ်။ အဲ့ဒီအချိန်မှာ သူသိထားတဲ့ Knowledge ကိုပါ သူနဲ့အတူ ပျောက်သွားရင် ပြဿနာဖြစ်တာ။",
      },
      { type: "h", text: "Bus Factor ဆိုတာ ဘာလဲ?" },
      {
        type: "p",
        text: "Bus Factor ဆိုတာ Team တစ်ခုရဲ့ အရေးကြီးတဲ့ Knowledge တွေကို လူဘယ်နှယောက်ပေါ် မှီခိုနေရလဲ ဆိုတာကို ပြောတာပါ။ ရိုးရိုးပြောရရင်— “အရေးကြီးတဲ့လူ ဘယ်နှယောက်မရှိတော့ရင် Project ကို ဆက်လုပ်ဖို့ အခက်အခဲဖြစ်သွားမလဲ?” ဥပမာ Team ထဲမှာ—",
      },
      {
        type: "p",
        text: "Database Structure → Dev A, Payment Logic → Dev B, Deployment → Dev C, Legacy Module → Dev D",
      },
      {
        type: "p",
        text: "ဆိုရင် Team မှာ လူ ၄ ယောက်ရှိပေမယ့် Knowledge တစ်ခုချင်းစီက တစ်ယောက်စီပေါ်မှာပဲ မှီနေတာ။ အဲ့ဒါက Risk ဖြစ်လာတယ်။",
      },
      { type: "h", text: "“ဒီ Module ကို ကျွန်တော်ပဲ သိတာ”" },
      {
        type: "p",
        text: "တစ်ခါတလေ ကိုယ်ပဲ System တစ်ခုကို အများဆုံးသိနေတော့ ကိုယ့်ကိုယ်ကို Valuable ဖြစ်တယ်လို့ ခံစားရတတ်တယ်။ တကယ်တော့— Company အတွက် ကိုယ်က Valuable ဖြစ်တာနဲ့ Project က ကိုယ့်အပေါ်ပဲ မှီနေတာက မတူဘူး။ ပိုကောင်းတဲ့အခြေအနေက— “ဒီ Module ကို Dev A က အကောင်းဆုံးသိတယ်။ ဒါပေမယ့် Dev B လည်း ဆက်လုပ်နိုင်တယ်” ဆိုတဲ့အခြေအနေ။ ဒါဆို Dev A Leave ယူသွားလည်း Project က ရပ်မသွားဘူး။",
      },
      { type: "h", text: "Documentation ရှိရုံနဲ့ မလုံလောက်ဘူး" },
      {
        type: "p",
        text: "“Document ရှိပါတယ်” ဆိုပြီး Bus Factor ပြဿနာ ပြီးသွားတာတော့ မဟုတ်ဘူး။ ဥပမာ Deployment Document ထဲမှာ—",
      },
      {
        type: "num",
        items: [
          { term: "Build", text: "" },
          { term: "SSH", text: "" },
          { term: "Run command", text: "" },
          { term: "Restart", text: "" },
        ],
      },
      {
        type: "p",
        text: "လောက်ပဲ ရှိပြီး “မရရင် Dev A ကိုမေးပါ” ဆိုရင် Document ရှိပေမယ့် Knowledge က Dev A ရဲ့ ခေါင်းထဲမှာပဲ ရှိနေသေးတယ်။ တကယ်လိုတာက Command တွေတင်မဟုတ်ဘူး။ ဘာကြောင့် ဒီလိုလုပ်ရတာလဲ၊ ဘာကို သတိထားရမလဲ၊ Error တက်ရင် ဘယ်လိုစစ်ရမလဲ၊ ပြဿနာဖြစ်ရင် ဘယ်လို Rollback လုပ်ရမလဲ ဆိုတာတွေလည်း သိထားဖို့လိုတယ်။",
      },
      { type: "h", text: "Code Review က Code Quality တင်မဟုတ်ဘူး" },
      {
        type: "p",
        text: "Code Review လုပ်တာကို တစ်ခါတလေ “Senior က Junior ရေးထားတာ စစ်ပေးတာ” လောက်ပဲ မြင်တတ်ကြတယ်။ တကယ်တော့ Knowledge Sharing အတွက်လည်း အရေးကြီးတယ်။ Dev A ရေးတဲ့ Code ကို Dev B Review လုပ်တယ်။ အဲ့ဒီအချိန်မှာ Dev B က Code ကိုပဲ မဖတ်ဘူး။ Business Logic ကိုပါ နားလည်လာတယ်။ နောက်တစ်ခါ Dev A မရှိတော့ရင် Dev B က ဆက်လုပ်နိုင်လာတယ်။",
      },
      {
        type: "p",
        text: "ဒါကြောင့် Code Review မှာ “ဒီ Code က မှန်လား?” တစ်ခုတည်းမဟုတ်ဘဲ “နောက်လူတစ်ယောက် ဒီ Code ကို နားလည်ပြီး ဆက်လုပ်နိုင်မလား?” ဆိုတာလည်း စဉ်းစားသင့်တယ်။",
      },
      { type: "h", text: "လူတိုင်းအရာအားလုံး သိဖို့လိုလား?" },
      {
        type: "p",
        text: "မလိုဘူး။ Bus Factor လျှော့တယ်ဆိုတာ လူတိုင်းက System တစ်ခုလုံးကို အကုန်သိရမယ် ဆိုတာမဟုတ်ဘူး။ ဥပမာ Payment Module ကို Dev A က Primary Owner ဖြစ်ပြီး Dev B က Secondary Owner ဖြစ်လို့ရတယ်။ အရေးကြီးတာက— Critical Knowledge ကို လူတစ်ယောက်တည်းမှာ Lock မလုပ်ထားဖို့ပဲ။",
      },
      { type: "h", text: "ကိုယ်မရှိရင် ဘာဖြစ်မလဲ?" },
      {
        type: "p",
        text: "ကိုယ်တစ်ပတ် Leave ယူသွားတယ်လို့ စဉ်းစားကြည့်။",
      },
      {
        type: "p",
        text: "“Database Issue တက်ရင် ဘယ်သူကြည့်မလဲ?” “Production Hotfix လိုရင် ဘယ်သူ Deploy လုပ်မလဲ?” “ဒီ Legacy Code က ဘာကြောင့် ဒီလိုရေးထားတာလဲဆိုတာ ဘယ်သူသိလဲ?”",
      },
      {
        type: "p",
        text: "အဖြေက အမြဲတမ်း— “Dev A ပြန်လာမှပဲ” ဖြစ်နေတယ်ဆိုရင် Bus Factor Risk ရှိနေပြီ။",
      },
      {
        type: "p",
        text: "Software Engineer တစ်ယောက်အနေနဲ့ Experience တိုးလာတာနဲ့အမျှ စဉ်းစားပုံကလည်း ပြောင်းလာသင့်တယ်။",
      },
      {
        type: "p",
        text: "Junior အနေနဲ့— “ဒီ Code ကို ငါရေးနိုင်လား?” နောက်ပိုင်းမှာ— “ဒီ Code ကို ငါကောင်းကောင်းရေးထားလား?” ပိုပြီး Experience ရလာရင်— “ငါမရှိရင် ဒီ Code ကို နောက်လူက နားလည်ပြီး ဆက်လုပ်နိုင်မလား?” အဲ့ဒီမေးခွန်းက ပိုအရေးကြီးလာတယ်။",
      },
      {
        type: "p",
        text: "နောက်ဆုံးတော့— “ဒီ System ကို ဘယ်သူအကောင်းဆုံးသိလဲ?” ထက် “သူမရှိရင် ဒီ System ကို ဘယ်သူဆက်လုပ်နိုင်လဲ?” ဆိုတာကို Team အနေနဲ့ စဉ်းစားနိုင်ဖို့လိုတယ်။",
      },
      {
        type: "p",
        text: "Knowledge ကို ကိုယ့်တစ်ယောက်တည်းမှာ သိမ်းထားရင် ကိုယ်က Important ဖြစ်လာနိုင်တယ်။ Knowledge ကို Share လုပ်ထားရင်တော့ Team က Strong ဖြစ်လာတယ်။",
      },
      {
        type: "quote",
        text: "Good Engineer ဆိုတာ သူမရှိရင် System ရပ်သွားအောင်လုပ်ထားတဲ့သူ မဟုတ်ဘူး။ သူမရှိလည်း System ဆက်သွားနိုင်အောင် Knowledge ကို ချန်ထားခဲ့တဲ့သူ ဖြစ်တယ်။",
      },
    ],
  },
];
